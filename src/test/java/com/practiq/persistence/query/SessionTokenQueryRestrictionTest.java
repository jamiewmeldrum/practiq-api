...
// SessionTokenQueryRestriction is a reusable component — any factory whose entity carries a session token can
...
class SessionTokenQueryRestrictionTest {
    ...
    void restrictRejectsANullSessionToken() {
        ...
        SessionTokenQueryRestriction<TestEntity> restriction =
                new SessionTokenQueryRestriction<>(sessionTokenAttribute);
    ...
    void restrictBuildsAnEqualityBetweenTheGivenAttributeAndTheQuerysToken() {
        ...
        QuerySpecification<TestEntity> specification =
                new SessionTokenQueryRestriction<>(sessionTokenAttribute).restrict(() -> sessionToken);
