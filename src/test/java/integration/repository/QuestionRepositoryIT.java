...
// Repository-mechanism concerns that involve no query runner: the @Version optimistic lock. What the student
// serving spec filters, stitches and orders is proven through the runner in
// integration.query.StudentQuestionQueryRunnerIT, which owns those repository calls.
@IntegrationTest
